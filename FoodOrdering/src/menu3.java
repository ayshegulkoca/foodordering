...
public class menu3 {
	 public void  menu(int dish1,int dish2,int dish3,int dish4,int dish5,String customerName,String customerAddress) {
	    	...
	    	System.out.println("Menu 3 Indian cuisine");
	    	 System.out.println("1. Naan - $5.99");
	    	    System.out.println("2. Lamb Tandoori - $8.99");
	    	    System.out.println("3. Chicken Tikka Masala - $6.99");
	    	    System.out.println("4. Lentil Dal - $3.99");
	    	    System.out.println("5. Shahi Paneer - $2.99");
	...
	Random ran = new Random();
	    	...
	    	System.out.println("****************************************************************");
	    	if(dish1>=1) { 
	    		System.out.println("Naan    "+dish1);
	    	}
	    	if(dish2>=1) { 
	    		System.out.println("Lamb Tandoori     "+dish2);
	    	}
	    	if(dish3>=1) { 
	    		System.out.println("Chicken Tikka Masala      "+dish3);
	    	}
	    	if(dish4>=1) { 
	    		System.out.println("Lentil Dal     "+dish4);
	    	}
	    	if(dish5>=1) { 
	    		System.out.println("Shahi Paneer "+dish5);
	    	}
