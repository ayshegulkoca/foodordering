...
public class menu5 {
	public void  menu(int dish1,int dish2,int dish3,int dish4,int dish5,String customerName,String customerAddress) {
    	...
    	System.out.println("Menu 5 Drinks ");
    	 System.out.println("1. Fruit Juice  - $5.99");
    	    System.out.println("2. Tea  - $8.99");
    	    System.out.println("3. Water - $6.99");
    	    System.out.println("4. Coffee - $3.99");
    	    System.out.println("5. Mai Tai - $2.99");
...
Random ran = new Random();
    	...
    	System.out.println("****************************************************************");
    	if(dish1>=1) { 
    		System.out.println("Fruit Juice    "+dish1);
    	}
    	if(dish2>=1) { 
    		System.out.println("Tea     "+dish2);
    	}
    	if(dish3>=1) { 
    		System.out.println("Water    "+dish3);
    	}
    	if(dish4>=1) { 
    		System.out.println("Coffee     "+dish4);
    	}
    	if(dish5>=1) { 
    		System.out.println("Mai Tai "+dish5);
    	}
