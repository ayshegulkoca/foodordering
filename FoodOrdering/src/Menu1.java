...
public class Menu1 {
    public void  menu(int dish1,int dish2,int dish3,int dish4,int dish5,String customerName,String customerAddress) {
    	...
    	System.out.println("Menu 1 european cuisine");
    	 System.out.println("1. Burger - $5.99");
    	    System.out.println("2. Pizza - $8.99");
    	    System.out.println("3. Pasta - $6.99");
    	    System.out.println("4. Salad - $3.99");
    	    System.out.println("5. Ice Cream - $2.99");
    ...
    public void  calc(int dish1,int dish2,int dish3,int dish4,int dish5,String customerName,String customerAddress,int calcu) {
    	...
    	System.err.println("The item you order is "+item+" how many "+item+" do you want to add to your cart?");
    	System.out.println("_________________________________________________________________________________");
    ...
    public void  reciept(int dish1,int dish2,int dish3,int dish4,int dish5,String customerName,String customerAddress) {
    	...
    	System.out.println("****************************************************************");
    	if(dish1>=1) { 
    		System.out.println("Burger    "+dish1);
    	}
    	if(dish2>=1) { 
    		System.out.println("Pizza     "+dish2);
    	}
    	if(dish3>=1) { 
    		System.out.println("Pasta     "+dish3);
    	}
    	if(dish4>=1) { 
    		System.out.println("Salad     "+dish4);
    	}
    	if(dish5>=1) { 
    		System.out.println("Ice cream "+dish5);
    	}
